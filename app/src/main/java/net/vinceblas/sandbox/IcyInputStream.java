...
public class IcyInputStream extends FilterInputStream {
     ...
     */
    protected IcyMetadataCallback icyMetadataCallback;
     ...
     * @param in             the underlying input stream
     * @param period         the period of metadata frame is repeating (in bytes)
     * @param icyMetadataCallback the callback - may be null
     */
    public IcyInputStream(InputStream in, int period, IcyMetadataCallback icyMetadataCallback) {
        this(in, period, icyMetadataCallback, null);
    }
     ...
     */
    public IcyInputStream(InputStream in, int period, IcyMetadataCallback icyMetadataCallback, String characterEncoding) {
        super(in);
        this.period = period;
        this.icyMetadataCallback = icyMetadataCallback;
    ...
    /**
     * Parses the metadata and sends them to IcyMetadataCallback.
     *
    ...
    protected void parseMetadata(String s) {
        ...
        for (String kv : kvs) {
            ...
            if (icyMetadataCallback != null) icyMetadataCallback.playerMetadata(key, val);
        }
    }
